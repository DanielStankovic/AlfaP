...
import com.kolibrialfaplam.microbs.kolibrialfaplam.utility.SendMail.MailContentType;
...
public class Mail extends javax.mail.Authenticator {
    ...
    public boolean send() throws Exception {
        ...
        if(!user.equals("") && !pass.equals("") && to.length > 0 && !from.equals("") && !subject.equals("") && !body.equals("")) {
            ...
            if(mailContentType.name().equals(MailContentType.MAIL_HTML_TYPE.name()))
            {
                messageBodyPart.setContent(body, "text/html; charset=utf-8");
            }
            else if(mailContentType.name().equals(MailContentType.MAIL_TEXT_TYPE.name()))
            {
